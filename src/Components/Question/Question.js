...
export default function Question() {
  return (
    <div class="pt-[145px] max-[420px]:pt-[48px] pb-[178px] max-[420px]:pb-[48px] flex flex-col justify-center items-center max-[420px]:items-start">
      <div class=" max-[420px]:w-[100%]">
        <h2 class="text-regular text-[48px] font-mainText max-[420px]:px-[10%] max-[420px]:text-[24px]">
